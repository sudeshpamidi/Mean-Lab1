...
$(document).ready(function() {
    ...
    function diplayTeamDetails(team) {
        ...
        let html = `
            ...
            <tr>
                <th>Gender:</th>
                <td>${team.TeamGender} <input type="hidden" id="teamgender" value="${team.TeamGender}"></td>
            </tr>            
            <tr>
                <th>Min. Age:</th>
    ...
    $("#btnSave").on("click", function() {
        ...
        if (!validator.validate("#frmPlayer") || !validatePlayer()) {
            return;
        }
    ...
    $("#playerModal").on('hidden.bs.modal', function() {
        $("#playerModal .modal-dialog").popover('dispose');
    });
    ...
    function validatePlayer() {
        let valid = true;
        let genderCheckedElement = $("input[name='gender']:checked");
        if ($("#teamgender").val() != genderCheckedElement.val()) {
            popover($("#playerModal .modal-dialog"), "The player gender is not bound to team's gender group.");
            valid = false;
        }
        return valid;
    };
